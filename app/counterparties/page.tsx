...
export default function PartiesPage() {
  ...
  return (
    <ResourceShell
      title="Counterparties"
      subtitle="Commodity-specific counterparty control reading the saved parcel."
    >
      ...
      <Card label="Counterparty State" title={model.hasPositiveSurplus ? "Counterparty Review Ready" : "Counterparty Review Required"}>
        <div className="grid gap-3">
          <Gate title={terms.sourceLabel} ready={model.hasCommodity} note={terms.sourceNote} />
          <Gate title="Buyer / Offtaker" ready={model.hasPrice} note="Buyer price, delivery basis, payment terms and acceptance conditions must be confirmed." />
          <Gate title="Transporter / Logistics" ready={model.logisticsUnit > 0 || !isRawFeedstock(model.stage)} note="Transport route, rate, vehicle basis and delivery point must be verified." />
          <Gate title={terms.processingLabel} ready={!terms.processingRequired || model.processingUnit > 0} note={terms.processingNote} />
        </div>
      </Card>
      ...
      <Card label="Commercial Context" title="Values to verify">
        <div className="grid gap-3">
          ...
          <Stat label="Effective Buyer / Offtake Price" value={moneyUnit(model.effectivePrice)} gold={model.hasPrice} danger={!model.hasPrice} />
