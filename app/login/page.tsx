    ...
    <main className="min-h-screen bg-[#050914] text-white">
      <div className="sticky top-0 z-50 border-b border-slate-800 bg-[#050914]/95 px-4 py-3">
        <nav className="mx-auto flex max-w-3xl items-center gap-2 overflow-x-auto rounded-full border border-slate-800 bg-slate-950/60 p-2">
          ...
          <div className="shrink-0 rounded-full bg-[#d7ad32] px-5 py-3 text-sm font-black text-[#07101c]">
            Login
          </div>

          <div className="shrink-0 rounded-full border border-slate-800 bg-slate-900/40 px-5 py-3 text-sm font-black text-slate-200">
            Request Access
          </div>
        </nav>
      </div>
