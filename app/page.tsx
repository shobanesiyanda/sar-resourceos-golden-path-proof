  ...
  return (
    <section className="rounded-2xl border border-[#202736] bg-[#0c1017] p-4">
      ...
      <div className="mb-3 flex gap-2 border-b border-[#1d2430] pb-3 text-[10px]">
        <Link
          href="/risk?view=alerts"
          className="rounded-full bg-[#1f1a0b] px-2 py-1 font-semibold text-[#f2ca63]"
        >
          Alerts (6)
        </Link>
        <Link
          href="/tasks?view=next-actions"
          className="rounded-full border border-[#1d2430] px-2 py-1 text-[#8b949e] hover:text-white"
        >
          Next Actions
        </Link>
        <Link
          href="/reports?view=insights"
          className="rounded-full border border-[#1d2430] px-2 py-1 text-[#8b949e] hover:text-white"
        >
          Insights
        </Link>
